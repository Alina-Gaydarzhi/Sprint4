...
public class AccordionFAQTest extends BaseTest {

    private int indexItemQuestion;
    private String expectedAnswerItem;

    public AccordionFAQTest(int indexItemQuestion, String expectedAnswerItem) {
        this.indexItemQuestion = indexItemQuestion;
        this.expectedAnswerItem = expectedAnswerItem;
    }

    @Parameterized.Parameters(name = "Вопрос {0}, ответ: {1}")
    public static Object[][] getAnswerQuestion() {
        return new Object[][]{
